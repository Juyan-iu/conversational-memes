...
from prompts.prompt_free_form_non_binary import SPLIT_INTO_GROUPS_HUMAN
...
# 사용하지 않는 프롬프트 더미 (argparse choices 유지용)
prompt_yes_no = prompt_free_form_non_binary
prompt_free_form_binary = prompt_free_form_non_binary
prompt_freq_guided_free_form_non_binary = prompt_free_form_non_binary
prompt_yes_no_mrbench = prompt_free_form_non_binary
prompt_scorer_freq = prompt_scorer
