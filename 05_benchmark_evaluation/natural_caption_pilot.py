...
GEN_PROMPT = (
    ...
    "Conversation the meme replies to:\n{conv}\n\n"
    "Write ONE short meme caption (under 8 words) that references the topic of "
    "this conversation using some of its key words, phrased the way a real "
    "person would caption a meme: punchy, natural, casual. Do not use quotes. "
    "Do not explain. Output the caption only."
)
